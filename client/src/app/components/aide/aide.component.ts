    ...
    template: `
        <div class="div-margin" xmlns="http://www.w3.org/1999/html">
            ...
            <div class="div-entreprise">
                ...
                <div class="div-border">
                    <p>Pour ajouter une entreprise, rendez-vous sur la page "Entreprise", où vous devez cliquer sur le
                        bouton "ajouter un stagiaire". <br/>
                ...
                <div class="div-border">
                    <p>Bien sûr, vous pouvez cliquer sur l'icône "oeil" pour voir toues les informations de l'entreprise
                        selectionée.</p>
                </div>
                <h4>Comment ajouter une inscription à une entreprise ? </h4>
                <div class="div-border">
                    <p>Une fois sur la page de l'"Entreprise", cliquer sur l'icône "homme". Cela vous dirigera vers un
                        formulaire où vous pourrez créer une inscription.</p>
                </div>
                <h4>Comment supprimer une entreprise ? </h4>
                <div class="div-border">
                    <p>Une fois sur la page de l'"Entreprise", cliquer sur l'icône "corbeille", cela aura pour effet de
                        supprimer l'entreprise selectionnée.</p>
                </div>
            </div>
            ...
            <div class="div-stagiaire">
                ...
                <div class="div-border">
                    <p>Pour ajouter un stagiaire, rendez-vous sur la page "Stagiaire", où vous devez cliquer sur le
                        bouton "ajouter un stagiaire". <br/>
                        Attention, vous devez avoir un statut "professeur" pour faire cette manipulation. <br/>
                        Vous pourrez alors remplir un formulaire avec un maximum d'informations possibles.</p>
                </div>
                ...
                <h4>N'y a t-il pas une autre solution pour voir ces informations ? </h4>
                <div class="div-border">
                    <p>Bien sûr, vous pouvez cliquer sur l'icône "oeil" pour voir toues les informations du stagaire
                        selectioné.</p>
                </div>
                <h4>Comment supprimer un stagiaire ? </h4>
                <div class="div-border">
                    <p>Une fois sur la page du "Stagiaire", cliquer sur l'icône "corbeille", cela aura pour effet de
                        supprimer le stagiaire selectionné.</p>
                </div>
            </div>
