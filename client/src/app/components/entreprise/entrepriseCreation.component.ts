        ...
        <div class="div-margin">
            ...
            <div>
                ...
                <mat-form-field class="ent-form-field" appearance="fill">
                    ...
                    <input matInput placeholder="Rue" [(ngModel)]="entreprise.rueEntreprise">
                </mat-form-field>
                <mat-form-field class="ent-form-field" appearance="fill">
                    <mat-label>Code Postal</mat-label>
                    <input matInput placeholder="Code Postal" [(ngModel)]="entreprise.cpEntreprise">
                </mat-form-field>
                <mat-form-field appearance="fill" class="ent-form-field">
                    <mat-label>Ville</mat-label>
                    <input matInput placeholder="Ville" [(ngModel)]="entreprise.villeEntreprise">
                </mat-form-field>
                <br>
                <mat-form-field appearance="fill" class="ent-form-field">
                    <mat-label>Télephone</mat-label>
                    <input matInput placeholder="Téléphone" [(ngModel)]="entreprise.telEntreprise">
                </mat-form-field>
                <mat-form-field appearance="fill" class="ent-form-field">
                    <mat-label>Fax</mat-label>
                    <input matInput placeholder="Fax" class="ent-form-field" [(ngModel)]="entreprise.faxEntreprise">
                </mat-form-field>
                <mat-form-field appearance="fill" class="ent-form-field">
            ...
            <div>
                ...
                <mat-form-field appearance="fill" class="ent-form-field">
                    ...
                    <input matInput placeholder="Niveau" [(ngModel)]="entreprise.niveau">
                </mat-form-field>
            </div>
            <div>
                <h2>Spécialité</h2>
